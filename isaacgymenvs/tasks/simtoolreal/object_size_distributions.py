...
class ObjectSizeDistribution:
    ...
    def __post_init__(self):
        assert len(self.handle_min_lengths) == len(
        ...
        assert (self.head_min_lengths is None) == (
            self.head_max_lengths is None
        ...
        assert (
            self.handle_min_density <= self.handle_max_density
        ...
        assert (self.head_min_density is None) == (
            self.head_max_density is None
        ...
        if self.head_min_lengths is not None and self.head_max_lengths is not None:
            assert len(self.head_min_lengths) == len(
            ...
            assert (
                self.head_min_density <= self.head_max_density
