...
def _get_entity_project_runid(wandb_url: str) -> Tuple[str, str, str]:
    ...
    entity, project, runs_or_groups, run_id_or_group_name = url_split[start_idx : start_idx + 4]
...
def restore_model_file_from_wandb(wandb_file_url: str, strict: bool = True, model=None) -> str:
